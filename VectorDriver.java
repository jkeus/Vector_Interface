...
public class VectorDriver {
	...
	public static void main(String[] args) {
		...
		v1.pushback(10);
		System.out.println("10 pushback capacity " + v1.capacity());
		v1.pushback(20);
		v1.pushback(30);
		System.out.println("30 pushabck capacity " + v1.capacity());
		v1.pushback(40);
      ...
      print(v1);	
		...
		System.out.println("Front: " + v1.front());
		print(v1);
		System.out.println("before major insert capacity " + v1.capacity());
		// erase range
		v1.insert(0, 44); // autoboxed
		System.out.println("44 insert capacity " + v1.capacity());
		v1.insert(0, Integer.valueOf(55)); // explictly create object
		System.out.println("55 insert capacity " + v1.capacity());
		v1.insert(0, 66);
		System.out.println("66 insert capacity " + v1.capacity());
		v1.insert(0, 77);
		System.out.println("77 insert capacity " + v1.capacity());
		print(v1);
		v1.erase(2, 4);
		System.out.println("erased capacity " + v1.capacity());
